...
HTML;
        ...
        $typeoptions = array();
        $typeoptions['engdoc'] = 'Doctor of Engineering (Eng.Doc)';
        ...
        $typeoptions['dclinsci'] = 'Doctor of Clinical Science (D.Clin.Sci.)';
        $typeoptions['msc'] = 'Master of Science by Research (M.Sc.)';
        $typeoptions['ma'] = 'Master of Arts by Research (M.A.)';
        $typeoptions['llm'] = 'Master of Law by Research (LL.M.)';
        $typeoptions['md'] = 'Doctor of Medicine (M.D.)';
        $typeoptions['msurg'] = 'Master of Surgery (M.Surg.)';

...
$string['type_phd'] = 'PHD';
$string['type_masters'] = 'Masters';
$string['type_other'] = 'Other';
$string['keywords'] = 'Keywords';
$string['keywords_help'] = 'Subject keywords';
$string['corp_acknowl'] = 'Corporate Acknowledgement';
$string['ident_no'] = 'Identification Number';
$string['department'] = 'Department';
$string['department_req'] = 'You must enter a department';
$string['no_pages'] = 'Number of pages';
$string['publishdate'] = 'Thesis date';
$string['publishdate_help'] = 'Date appearing on the title page of your thesis';
$string['publishdate_req'] = 'You must enter a thesis date';
...
$string['quals_taughtmasters'] = 'Taught masters';
